...
input_video = "wrong_motivation_all.mp4" # Thay bằng đường dẫn file của bạn
output_video = "motivation/wrong_motivation_all.mp4"
...
# Lưu video mới (bỏ âm thanh hoặc giữ qua aureasoningdio=False/True)
